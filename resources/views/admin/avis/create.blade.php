...
@section('page-title', 'Nouvel avis client')
@section('page-subtitle', 'Ajouter un témoignage pour la section "Ce qu\'ils disent de nous"')

@section('content')

<style>
/* ============================================================
   AVIS CREATE — Design system harmonisé
============================================================ */
.form-page {
    max-width: 1200px;
}
...
<div class="form-page">
    ...
    <form action="{{ route('admin.avis.store') }}" method="POST" enctype="multipart/form-data" id="avisForm" novalidate>
        @csrf
        ...
        <div class="form-shell">
                        ...
                        <div class="field-row">
                            ...
                            <div class="field-group">
                                ...
                                <div class="field-input-wrap">
                                    ...
                                    <input type="text" id="entreprise_nom" name="entreprise_nom" class="field-input" placeholder="Ex : Société Générale" required maxlength="150" value="{{ old('entreprise_nom') }}">
                                </div>
                            ...
                            <div class="field-group">
                                ...
                                <div class="img-preview-box" id="imgBox">
                                    <input type="file" name="logo_entreprise" id="imageInput" accept="image/*">
                        ...
                        <div class="field-row">
                            ...
                            <div class="field-group">
                                ...
                                <div class="field-input-wrap">
                                    ...
                                    <input type="text" id="contact_nom" name="contact_nom" class="field-input" placeholder="Ex : Jean Dupont" maxlength="100" value="{{ old('contact_nom') }}">
                                </div>
                            </div>
                            ...
                            <div class="field-group">
                                ...
                                <div class="field-input-wrap">
                                    ...
                                    <input type="text" id="contact_fonction" name="contact_fonction" class="field-input" placeholder="Ex : Directeur RH" maxlength="100" value="{{ old('contact_fonction') }}">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-section-body">
                        ...
                        <div class="field-group" style="margin-bottom: 20px;">
                            ...
                            <div class="star-rating" id="starRating">
                                <input type="radio" id="star5" name="note" value="5" {{ old('note') == 5 ? 'checked' : '' }}>
                                <label for="star5">★</label>
                                <input type="radio" id="star4" name="note" value="4" {{ old('note') == 4 ? 'checked' : '' }}>
                                <label for="star4">★</label>
                                <input type="radio" id="star3" name="note" value="3" {{ old('note') == 3 ? 'checked' : '' }}>
                                <label for="star3">★</label>
                                <input type="radio" id="star2" name="note" value="2" {{ old('note') == 2 ? 'checked' : '' }}>
                                <label for="star2">★</label>
                                <input type="radio" id="star1" name="note" value="1" {{ old('note') == 1 ? 'checked' : '' }}>
                        ...
                        <div class="field-group">
                            ...
                            <div class="textarea-wrap" style="position: relative;">
                                <textarea id="contenu" name="contenu" class="field-textarea" rows="4" placeholder="Le témoignage du client…" maxlength="2000" required>{{ old('contenu') }}</textarea>
                                <span class="char-count" style="position: absolute; bottom: 8px; right: 12px; font-size: 11px; color: var(--text-muted);"><span id="contentCount">0</span>/2000</span>
                            </div>
                            ...
                            <div class="field-group">
                                ...
                                <label class="toggle-field" for="misEnAvant">
                                    ...
                                    <div class="toggle-switch">
                                        <input type="checkbox" id="misEnAvant" name="mis_en_avant" value="1" {{ old('mis_en_avant') ? 'checked' : '' }}>
            ...
            <div>
                ...
                {{-- Champs requis --}}
                <div style="display:flex;align-items:center;gap:6px;font-size:11.5px;color:var(--text-muted, #94a3b8);padding:12px 2px;">
                    <span class="required-dot"></span>
                    Champs obligatoires
                </div>

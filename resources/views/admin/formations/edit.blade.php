...
@section('page-subtitle', 'Mettre à jour les informations de la formation')

@section('content')

<style>
/* ============================================================
   FORMATIONS EDIT — Design system harmonisé
============================================================ */
.form-page {
    max-width: 1000px;
}
...
<div class="form-page">
    ...
    <form action="{{ route('admin.formations.update', $formation) }}" method="POST" enctype="multipart/form-data" id="formationForm" novalidate>
        @csrf
        @method('PUT')
        <input type="hidden" name="catalogue_id" value="{{ $formation->catalogue_id }}">
                ...
                <div class="form-section">
                    <div class="form-section-head">
                        ...
                        <div class="form-section-head-text">
                            ...
                            <p>Titre, lieu et visibilité</p>
                        </div>
                    </div>
                    <div class="form-section-body">
                    
                <div class="field-group">
    <label class="field-label">Catalogue associé</label>
    <input type="text" class="field-input" value="{{ $formation->catalogue->titre ?? 'Non défini' }}" disabled readonly>
    <span class="field-hint">Le catalogue ne peut pas être modifié après création</span>
    <br>
</div>
                        ...
                        <div class="field-row">
                            ...
                            <div class="field-group">
                                ...
                                <div class="field-input-wrap">
                                    ...
                                    <input type="text" id="titre" name="titre" class="field-input" placeholder="Ex : Management d'équipe" required maxlength="200" value="{{ old('titre', $formation->titre) }}">
                                </div>
                            ...
                            <div class="field-group">
                                ...
                                <div class="field-input-wrap">
                                    ...
                                    <input type="text" id="lieu" name="lieu" class="field-input" placeholder="Ex : Antananarivo, en ligne" required maxlength="150" value="{{ old('lieu', $formation->lieu) }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="field-group" style="margin-bottom: 0;">
                            ...
                            <label class="toggle-field" for="actifToggle">
                                ...
                                <div class="toggle-switch">
                                    <input type="checkbox" id="actifToggle" name="actif" value="1" {{ old('actif', $formation->actif) ? 'checked' : '' }}>
                    ...
                    <div class="form-section-body">
                        ...
                        <div class="field-row">
                            <div class="field-group">
                                ...
                                <input type="date" id="date_debut" name="date_debut" class="field-input" required value="{{ old('date_debut', $formation->date_debut ? $formation->date_debut->format('Y-m-d') : '') }}">
                            </div>
                            <div class="field-group">
                                <label class="field-label" for="date_fin">Date de fin</label>
                                <input type="date" id="date_fin" name="date_fin" class="field-input" value="{{ old('date_fin', $formation->date_fin ? $formation->date_fin->format('Y-m-d') : '') }}">
                        ...
                        <div class="field-row">
                            <div class="field-group">
                                ...
                                <div class="field-input-wrap">
                                    ...
                                    <input type="time" id="heure" name="heure" class="field-input" value="{{ old('heure', $formation->heure) }}">
                                </div>
                            </div>
                            <div class="field-group">
                                ...
                                <div class="field-input-wrap">
                                    ...
                                    <input type="number" id="places_max" name="places_max" class="field-input" min="0" value="{{ old('places_max', $formation->places_max) }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="field-row">
                            <div class="field-group">
                                ...
                                <div class="field-input-wrap">
                                    ...
                                    <input type="number" id="prix" name="prix" class="field-input" min="0" step="1000" value="{{ old('prix', $formation->prix) }}">
                                </div>
                            </div>
                            <div class="field-group">
                                ...
                                <div class="field-input-wrap">
                                    ...
                                    <input type="url" id="lien_inscription" name="lien_inscription" class="field-input" placeholder="https://exemple.com/inscription" value="{{ old('lien_inscription', $formation->lien_inscription) }}">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-section-body">
                        ...
                        <div class="field-group" style="margin-bottom: 20px;">
                            ...
                            <div class="textarea-wrap">
                                <textarea id="description_courte" name="description_courte" class="field-textarea short" rows="3" maxlength="300" placeholder="Résumé de la formation…">{{ old('description_courte', $formation->description_courte) }}</textarea>
                        ...
                        <div class="field-group">
                            ...
                            <div class="textarea-wrap">
                                <textarea id="description" name="description" class="field-textarea" rows="6" placeholder="Programme détaillé, prérequis, intervenants…">{{ old('description', $formation->description) }}</textarea>
                ...
                <div class="form-section">
                    ...
                    <div class="form-section-body">
                        ...
                        <div class="existing-img" id="existingImgBlock">
                            <img src="{{ asset('storage/'.$formation->image) }}" alt="Image actuelle">
...
(function() {
    ...
    clearImgBtn?.addEventListener('click', function() {
        if (confirm('Supprimer l\'image actuelle ?')) {
            ...
            hiddenInput.value = '1';
            document.getElementById('formationForm').appendChild(hiddenInput);

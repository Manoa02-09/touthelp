...
@section('content')
    ...
    <div class="form-page">
        ...
        <form action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data" id="articleForm" novalidate>
            @csrf
                    ...
                    <div class="form-section">
                        <div class="form-section-head">
                            ...
                            <div class="form-section-head-text">
                                ...
                                <p>Titre, auteur, date et image de couverture</p>
                            </div>
                        </div>
                        <div class="form-section-body">
                            ...
                            <div class="field-row">
                                ...
                                <div class="field-group">
                                    ...
                                    <div class="field-input-wrap">
                                        ...
                                        <input type="text" id="titre" name="titre" class="field-input" placeholder="Ex : Les nouvelles tendances RH 2025" required maxlength="200" value="{{ old('titre') }}">
                                    </div>
                                ...
                                <div class="field-group">
                                    ...
                                    <div class="field-input-wrap">
                                        ...
                                        <input type="date" id="date_publication" name="date_publication" class="field-input" required value="{{ old('date_publication', date('Y-m-d')) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="field-group" style="margin-bottom: 16px;">
                                ...
                                <div class="field-input-wrap">
                                    ...
                                    <input type="text" id="auteur" name="auteur" class="field-input" placeholder="Ex: Mahefa A. RAVALISON" required maxlength="100" value="{{ old('auteur') }}">
                                </div>
                                <div class="field-error-msg" id="auteurError">
                                    <svg width="12" height="12" fill="none" stroke="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M12 8v4m0 4h.01"/></svg>
                                    L'auteur est requis
                                </div>
                            </div>
                            ...
                            <div class="field-group">
                                ...
                                <span class="field-hint">Image de couverture de l'article</span>
                            </div>
                        ...
                        <div class="form-section-body">
                            ...
                            <div class="field-group" style="margin-bottom: 20px;">
                                ...
                                <div class="textarea-wrap" style="position: relative;">
                                    <textarea id="extrait" name="extrait" class="field-textarea" rows="3" maxlength="300" placeholder="Résumé de l'article qui apparaîtra dans les cartes…">{{ old('extrait') }}</textarea>
                            ...
                            <div class="field-group">
                                ...
                                <div class="textarea-wrap" style="position: relative;">
                                    <textarea id="contenu" name="contenu" class="field-textarea content-editor" rows="12" placeholder="Rédigez votre article ici… (HTML accepté)" required>{{ old('contenu') }}</textarea>
                    ...
                    <div class="preview-card">
                        ...
                        <div class="preview-card-body">
                            <div class="preview-article">
                                ...
                                <div class="preview-auteur" id="previewAuteur">✍️ Auteur</div>
    ...
    (function() {
        ...
        function updatePreview() {
            ...
            const auteur = auteurInput?.value.trim() || 'Auteur';
            ...
            previewAuteur.textContent = `✍️ ${auteur}`;
        ...
        auteurInput?.addEventListener('input', updateFormStatus);
        ...
        const auteurError = document.getElementById('auteurError');
        ...
        form?.addEventListener('submit', function(e) {
            ...
            if (!auteur) {
                e.preventDefault();
                auteurInput?.classList.add('has-error');
                auteurError?.classList.add('show');
                valid = false;
            } else {
                auteurInput?.classList.remove('has-error');
                auteurError?.classList.remove('show');
            }

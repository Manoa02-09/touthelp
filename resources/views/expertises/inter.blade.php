...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Barlow+Condensed:ital,wght@0,400;0,600;0,700;0,800;0,900;1,700;1,800;1,900&family=Barlow:wght@400;500;600;700&display=swap"
        rel="stylesheet">
...
<body>
    ...
    <main>
        <div class="content-card">
            <div class="content-left">
                ...
                <div class="space-y-4">
                    <p>Nos formations interentreprises permettent à vos collaborateurs de monter en compétence dans un
                        cadre structuré et dynamique.</p>
                    <p>Elles offrent un environnement propice au partage d'expériences et à l'acquisition de bonnes
                        pratiques immédiatement applicables dans votre secteur.</p>
                </div>

                <h3 class="font-black text-xs uppercase tracking-widest mt-8 mb-4 text-slate-800">🧩 Ce que nous
                    proposons</h3>
        ...
        <div class="info-box">
            ...
            <p>Ces formations s'adressent aux professionnels souhaitant renforcer leurs compétences, s'initier à de
                nouvelles pratiques ou échanger avec d'autres acteurs du secteur.</p>
        </div>
    </main>

    <footer
        style="text-align: center; padding: 50px; color: #94a3b8; font-family: 'Barlow Condensed'; font-weight: 700; letter-spacing: 0.2em; text-transform: uppercase; font-size: 12px;">
    ...
    <div class="chat-modal" id="chatModal">
        ...
        <div id="chatInputArea" class="chat-input-area" style="display:none;">
            ...
            <button id="chatSendBtn" class="chat-send-btn"><svg width="16" height="16" viewBox="0 0 24 24" fill="white">
        ...
        <div id="chatInitForm" class="chat-init-form">
            ...
            <textarea id="initMessage" rows="2" placeholder="Votre message *" style="resize:none;"
                maxlength="1000"></textarea>
        ...
        <div id="changeIdentityBar" style="display:none;background:white;border-top:1px solid #ffe0e0;"><button
                class="change-identity-btn" onclick="resetChat()"><i class="fas fa-user-edit mr-1"></i> Nouvelle
